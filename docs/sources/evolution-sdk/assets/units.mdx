...
- [Assets Overview](/docs/assets) — Creating and merging asset bundles
- [Metadata](/docs/assets/metadata) — Attach metadata to transactions
- [Simple Payment](/docs/transactions/simple-payment) — Send native tokens
