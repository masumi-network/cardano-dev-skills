...
[Learn about the Address module →](/docs/addresses/address)
...
const paymentCred = new KeyHash.KeyHash({ hash: new Uint8Array(28) });
const stakeCred = new KeyHash.KeyHash({ hash: new Uint8Array(28) });
...
**Core Concepts:**
- [Address](/docs/addresses/address) - How to parse, validate, and convert addresses
