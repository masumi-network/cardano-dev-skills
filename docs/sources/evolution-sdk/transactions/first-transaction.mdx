...
- [Simple Payment](/docs/transactions/simple-payment) - Common payment patterns and examples
- [Multi-Output](/docs/transactions/multi-output) - Send to multiple addresses in one transaction
- [Wallets](/docs/wallets) - Different wallet types and configuration
- [Querying](/docs/querying) - Check transaction status and balances
