...
const tx = await client
  ...
  .mintAssets({
    assets,
    redeemer: Data.constr(0n, []) // "Mint" action
  })
...
- [Spending from Script](/docs/smart-contracts/spending) — Using redeemers in spend transactions
- [Datums](/docs/smart-contracts/datums) — The other half of script data
