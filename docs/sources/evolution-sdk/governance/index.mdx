...
<Cards>
  <Card title="DRep Registration" href="/docs/governance/drep-registration">
    Register, update, and deregister as a DRep
  </Card>
  <Card title="Voting" href="/docs/governance/voting">
    Cast votes on governance actions
  </Card>
  <Card title="Proposals" href="/docs/governance/proposals">
    Submit governance proposals
  </Card>
  <Card title="Vote Delegation" href="/docs/governance/vote-delegation">
